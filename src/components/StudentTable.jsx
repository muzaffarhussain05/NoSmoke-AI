...
export default function StudentTable({ filteredStudents, handleEditStudent, handleDeleteStudent }) {
  return (
                    ...
                    <TableCell>
                      <div className="flex space-x-1 sm:space-x-2">
                        <button
                          ...
                          className="border border-gray-600 text-gray-300 hover:bg-gray-700 p-1 sm:p-2 rounded"
                        >
                          <Edit className="h-3 w-3 sm:h-4 sm:w-4" />
                        </button>
                        <button
                          onClick={() => handleDeleteStudent(student.rollNo)}
                          className="text-red-500 hover:bg-gray-700 p-1 sm:p-2 rounded"
                        >
